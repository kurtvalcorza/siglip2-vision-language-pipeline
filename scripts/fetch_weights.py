#!/usr/bin/env python
"""Download and verify base-model weights for the SigLIP 2 vision-language pipeline.

Downloads and verifies the pinned Hugging Face SigLIP 2 checkpoint
...
Usage:
    ...
    # Download default model (siglip2-base-patch16-224) into weights/siglip2-base-patch16-224/:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download and verify base-model weights for SigLIP 2 pipeline."
    )
    parser.add_argument(
        "--dest",
        type=Path,
