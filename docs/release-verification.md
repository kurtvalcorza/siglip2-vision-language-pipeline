...
|---|---|---|---|---|
| `siglip2_vision_language_colab.ipynb` (`E2E`) | pending | — | — | **PENDING** — a clean-runtime execution of the `E2E` blob has not been recorded yet |
...
suite; the model-backed regressions (`tests/test_model_backed.py`, 6 tests) pass on CPU and on the RTX 5070 Ti in
